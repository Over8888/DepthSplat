...
def run_experiment5():
    print("=" * 60)
    print("Experiment 5: Gaussian / Point Cloud Diagnostics (depth-color centers)")
    print(f"Output: {EXP5_ROOT}")
    print("=" * 60)
    ...
    for scene_key in SCENE_KEYS:
        ...
        render_diagnostic_grid(
            ...
            depth_color_only=True,
        )

        gc.collect()

    print(f"\n{'=' * 60}")
    print(f"Done! Results in: {EXP5_ROOT}")
    print(f"{'=' * 60}")
