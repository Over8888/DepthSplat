...
set -euo pipefail
# ================================================================
# DepthSplat Base | re10k+DL3DV | 6-view | 512×960
# Checkpoint: depthsplat-gs-base-re10kdl3dv-448x768-randview2-6-f8ddd845.pth
# Training:   re10k → (re10k+dl3dv) | 2-6 views | 117M params | vitb
# ================================================================
...
output_dir=outputs/depthsplat-re10kdl3dv-base-6view
