#!/usr/bin/env bash
set -euo pipefail
# RE10K large 4-view: uses base re10k+dl3dv checkpoint with base configuration.
...
OUTPUT_DIR="${OUTPUT_DIR:-/root/autodl-tmp/outputs/depthsplat_best_configs/re10k_large_4view}"
