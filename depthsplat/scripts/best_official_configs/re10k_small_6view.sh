#!/usr/bin/env bash
set -euo pipefail
# Official DepthSplat best RE10K-compatible config: small model, 6-view, 512x960.
# Checkpoint training views: 4-10. Mirrors official re10kdl3dv/small_6view.sh.

PROJECT_ROOT="${PROJECT_ROOT:-/root/depthsplat}"
DATA_ROOT="${DATA_ROOT:-/root/depthsplat/datasets/re10k_720p}"
OUTPUT_DIR="${OUTPUT_DIR:-/root/autodl-tmp/outputs/depthsplat_best_configs/re10k_small_6view}"
